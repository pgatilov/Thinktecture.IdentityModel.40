...
namespace Thinktecture.Samples
{
    public static class Constants
    {
        ...
        public const string IdSrv = "localhost";
        public const string ACS = "brockallen.accesscontrol.windows.net";
        ...
        public const string Realm = "https://localhost/webapisecurity/";
